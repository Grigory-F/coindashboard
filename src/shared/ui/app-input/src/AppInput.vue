<template>
  ...
  >
    <RouterLink :to="{ name: useAppRoute('home') }"></RouterLink>
    <div
    ...
    >
      <div class="app-input-container__left-slot" v-if="isLeftInputAddons">
        <slot name="leftInputAddons"></slot>
      </div>
      <div class="app-input-container__input-wrapper">
        <span class="app-input-container__input-label">{{ props.label }}</span>
        <input
      ...
      <div class="app-input-container__right-slot" v-if="isRightInputAddons">
        <slot name="rightInputAddons"></slot>
      </div>
    </div>

    <div
      class="app-input__hint-message"
...
import { useAppRoute } from "@/shared/lib";
